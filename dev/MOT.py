...
class MOTinterface(mli.Interface):
    ...
    def __init__(self,n1trust,n2trust,simultaneous_fitting=True):
    ...
    def n3(self,t,L,g,b):
        ...
        b : float
            ...
            between trapped atoms and the gaussian 
            width of the trap.
    ...
    def _n2_fitting(self,L=None):
        ...
        if L == None:
            ...
            fitLg, fitLg_cov = optimize.curve_fit(self.n2, n2_fitting_data[:,0], n2_fitting_data[:,1],p0=[self._L*0.9,self._g])
